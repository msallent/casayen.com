...
export function Hero() {
  return (
    <div className="font-title-full relative mx-5 mb-14 flex flex-col text-[24vw] sm:mb-20 sm:text-[16vw]">
      ...
      <div className="relative ml-[6%] flex items-center gap-1.5 sm:mt-20 sm:ml-[22%] md:mt-24 md:ml-[27%] lg:ml-[18%]">
        ...
        <h1>VIAJE</h1>
        <EllipsisSVG className="pointer-events-none absolute top-[-30%] left-[4%] z-10 w-[16.5rem] lg:top-[-50%] lg:left-[5%] lg:w-[30rem]" />
