...
export function Hero() {
  return (
    <div className="font-title-full relative mx-5 mb-14 flex flex-col text-[24vw] sm:mb-20 sm:text-[16vw]">
      <Stars2SVG className="hidden sm:mx-auto sm:mb-20 sm:block sm:w-3/5 md:mb-24" />

      <div className="relative ml-[6%] flex items-center gap-1.5 sm:ml-[22%] md:ml-[27%]">
        ...
        <Stars1SVG className="pointer-events-none absolute top-[-60%] left-[87%] z-10 w-12 sm:left-[75%] md:left-[73%] md:w-14" />
      </div>
      ...
      <div className="hidden sm:block sm:text-center">
        ...
        <h1 className="sm:relative">
          <span>SEXUAL</span>
          <div className="sm:absolute sm:top-[-54%] sm:right-[28%] sm:rotate-90 sm:text-[3rem]">
            ‡
          </div>
        </h1>
      </div>
